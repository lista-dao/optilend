  ...
  IMorphoFlashLoanCallback
{
  ...
  function testFlashActions(uint256 loanAmount) public {
    ...
    assertGt(morpho.position(marketParams.id(), address(this)).borrowShares, 0, "no borrow");
    ...
    assertEq(morpho.position(marketParams.id(), address(this)).collateral, 0, "no withdraw collateral");
  }
}
