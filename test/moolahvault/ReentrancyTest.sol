...
import { IMoolahVault } from "moolahvault/interfaces/IMoolahVault.sol";

import { ERC1820Registry } from "moolahvault/mocks/ERC1820Registry.sol";
import { ERC777Mock, IERC1820Registry } from "moolahvault/mocks/ERC777Mock.sol";
...
contract ReentrancyTest is IntegrationTest, IERC1820Implementer {
  ...
  function setUp() public override {
    ...
    vault = newMoolahVault(OWNER, OWNER, address(moolah), TIMELOCK, address(reentrantToken), "Moolah Vault", "MMV");
    ...
    console2.log(
      "Supplier deposited %s loanTokens to moolahvault_no_timelock in exchange for %s shares.",
