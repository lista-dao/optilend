...
contract IntegrationTest is BaseTest {
  ...
  function setUp() public virtual override {
    ...
    vault = createMoolahVault(OWNER, address(moolah), TIMELOCK, address(loanToken), "Moolah Vault", "MMV");
  ...
  function createMoolahVault(
    ...
    return newMoolahVault(owner, owner, moolah, initialTimelock, asset, name, symbol);
  }
  ...
  function _setGuardian(address newGuardian) internal {
    ...
    assertTrue(vault.hasRole(GUARDIAN_ROLE, newGuardian), "_setGuardian");
  }
